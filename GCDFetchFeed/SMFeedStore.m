...
+ (NSMutableArray *)defaultFeeds {
    ...
    SMFeedModel *kunnanFeed = [[SMFeedModel alloc] init];
    kunnanFeed.title = @"https://kunnan.blog.csdn.net";
    //feed:https://blog.csdn.net/z929118967/rss/list
    kunnanFeed.feedUrl = @"https://blog.csdn.net/z929118967/rss/list";
    kunnanFeed.imageUrl = @"https://github.com/ming1016/GCDFetchFeed/blob/master/GCDFetchFeed/resource/logo_starming.png?raw=true";
    kunnanFeed.des = @"kunnan的博客";
    [mArr addObject:kunnanFeed];
